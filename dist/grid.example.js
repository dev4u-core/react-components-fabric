...
/***/ function(module, exports, __webpack_require__) {
	...
	var dataSource = new dev4u_react_components_1.ClientDataSource([
	    { title: 'title0', description: 'description0' },
	    { title: 'title1', description: 'description1' },
	    { title: 'title2', description: 'description2' }
	]);
	dataSource.dataBind();
	ReactDom.render(React.createElement(dev4u_react_components_1.Grid, {columns: columns, dataSource: dataSource}), document.getElementById('grid'));
